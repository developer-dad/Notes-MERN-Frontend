...
const FullNoteState = ({ setFullNote, setEditNote, editNote, note }) => {
  ...
  return (
    <div className="fixed inset-0 z-20 h-screen w-screen bg-white dark:bg-neutral-500 flex flex-col">
      <div
        className={`flex items-center justify-between p-5 ${note.color.bg}`}
      >
        <IoArrowBackSharp
      ...
      <div className="p-5 flex-1 flex-col gap-3 overflow-auto">
        <div className="text-2xl dark:text-white">{note.title}</div>
